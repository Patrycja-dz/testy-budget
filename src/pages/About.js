    ...
    <>
      ...
      <div className="about">
	   ...
	   <div className="about__element">
          <h3 className="about__title">We Have Free Templates for Everyone</h3>
          <p className="about__description">
            ...
            meticulously sliced and coded. What's more, they're absolutely free!
            You can do a lot with them. You can modify them. You can use them to
            design websites for clients, so long as you agree with the Terms of
            Use. You can even remove all our links if you want to.
          </p>
        </div>
        <div className="about__element">
          <h3 className="about__title">We Have More Templates for You</h3>
          <p className="about__description">
        ...
        <div className="about__element">
          <h3 className="about__title">Be Part of Our Community</h3>
          <p className="about__description">
        ...
        <div className="about__element">
          <h3 className="about__title">Template Details</h3>
          <p className="about__description">
